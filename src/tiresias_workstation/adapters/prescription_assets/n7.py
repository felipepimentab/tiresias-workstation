"""Provide the bundled N7 standard-audiogram prescription."""
...
N7_PRESCRIPTION = Prescription(
    profile_id="N7",
    display_name="N7 standard audiogram",
    description=(
    ...
    expected_sha256="072d219ccb4c79ecb965da28572427b2d73479846fe2e265130ced2b4827b048",
    source=PrescriptionSource(
        repository="tiresias-eval",
        path=(
            "tiresias-eval-sigma/scripts/generated/N7/"
            "N7_apply_prescription.sss"
        ),
        revision="e1cb13dd9e1e9a941575f9f836eb56418d4ff812",
        sha256="4091692572db008cf8f83441826e0ed955e58af0009995dde21010fd2ad114f8",
    ),
)
